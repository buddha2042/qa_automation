      ...
      <div className="max-w-7xl mx-auto p-8">
        <header className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end border-b border-gray-800 pb-6 gap-4">
          <div>
            ...
            <p className="text-gray-400 mt-2">Map and export Dashboard IDs with Widget IDs</p>
          </div>
        ...
        {error && (
          <div className="mb-6 bg-red-900/20 border border-red-500/50 p-4 rounded text-red-400 text-sm flex items-center gap-2">
            <span>⚠️</span> {error}
          </div>
        )}
                ...
                {results[env].length === 0 ? (
                  ...
                  <div className="space-y-6">
                    {results[env].map((dash) => (
                      <div key={`${dash.dashboardId}-${env}`} className="bg-gray-800/40 rounded-xl border border-gray-700/50 p-4 hover:border-gray-600 transition-colors shadow-sm">
                        <div className="mb-4">
